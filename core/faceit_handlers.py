...
from ..core.faceit_data import FACEIT_VERTEX_GROUPS, LIVE_MOCAP_DEFAULT_SETTINGS
...
def register_vertex_group_defaults(scene):
...
def register_default_properties():
    ...
    print('Registering default properties')
    scene = bpy.context.scene
    register_vertex_group_defaults(scene)
    register_mocap_engine_defaults(scene)
    print('Removed default properties handler')
