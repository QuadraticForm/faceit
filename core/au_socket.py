...
# # thread function
# # def threaded(msg):
# #     print(_parse_datagram(msg))


# keys = ["browInnerUp", "browDown_L", "browDown_R", "browOuterUp_L", "browOuterUp_R", "eyeLookUp_L", "eyeLookUp_R",
#         "eyeLookDown_L", "eyeLookDown_R", "eyeLookIn_L", "eyeLookIn_R", "eyeLookOut_L", "eyeLookOut_R", "eyeBlink_L",
#         "eyeBlink_R", "eyeSquint_L", "eyeSquint_R", "eyeWide_L", "eyeWide_R", "cheekPuff", "cheekSquint_L",
#         "cheekSquint_R", "noseSneer_L", "noseSneer_R", "jawOpen", "jawForward", "jawLeft", "jawRight", "mouthFunnel",
#         "mouthPucker", "mouthLeft", "mouthRight", "mouthRollUpper", "mouthRollLower", "mouthShrugUpper",
#         "mouthShrugLower", "mouthClose", "mouthSmile_L", "mouthSmile_R", "mouthFrown_L", "mouthFrown_R",
#         "mouthDimple_L", "mouthDimple_R", "mouthUpperUp_L", "mouthUpperUp_R", "mouthLowerDown_L", "mouthLowerDown_R",
#         "mouthPress_L", "mouthPress_R", "mouthStretch_L", "mouthStretch_R", "tongueOut"]


# def log_au(msg):

#     address, params = _parse_datagram(msg)
#     if address == "/W":  # Action Units.
#         au_index = params[0]
#         au_val = params[1]
#         au_name = keys[au_index]
#         print('%s : %f' % (au_name, au_val))
#     elif address == "/HR":  # head rotation.
#         rx = params[0]
#         ry = params[0]
#         rz = params[0]
#         print('rx:%f ry:%f rz:%f' % (rx, ry, rz))
#     elif address == "/HT":  # Head translation.
#         tx = params[0]
#         ty = params[0]
#         tz = params[0]
#         print('tx:%f ty:%f tz:%f' % (tx, ty, tz))


# # HOST = "127.0.0.1"  # Standard loopback interface address (localhost)
# HOST = "192.168.11.78"  # Standard loopback interface address (localhost)
...
#         if i == 1000:
#             break
#         print(f'time: {round(time.time() - time_run, 10)}')
#         # not sure youwant to unpack on a thread on not...
#         # this seems pretty lightweight?
#         #start_new_thread(threaded, (msg,))
