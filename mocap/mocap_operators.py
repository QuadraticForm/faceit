...
# if self.engine == 'A2F':
#     mocap_importer = A2FMocapImporter()
#     record_frame_rate = self.a2f_frame_rate
# elif self.engine == 'FACECAP':
#     mocap_importer = FaceCapImporter()
#     record_frame_rate = 1000
# elif self.engine == 'EPIC':
#     mocap_importer = EpicMocapImporter()
