...
class FACEIT_OT_SmartBind(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for obj in face_objects:
            ...
            obj_settings[obj.name] = {'topology_mirror': obj.data.use_mirror_topology}
        ...
        for obj, dup_obj in dup_objects_dict.items():
            ...
            # --------------------------------------------------------------
            # obj_settings[obj.name] = {'topology_mirror':obj.data.use_topology_mirror}
    ...
    def _apply_smart_weighting(
        ...
        bpy.ops.object.mode_set(mode='OBJECT')
        face_hull = bind_utils.create_facial_hull(context, landmarks_object)
